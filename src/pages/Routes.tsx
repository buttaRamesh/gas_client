      ...
      >
        {filteredRoutes.map((route) => (
          <Card
            ...
            sx={{
              height: "100%",
              background: "linear-gradient(145deg, hsl(var(--muted)) 0%, hsla(var(--card-gradient-end), 0.08) 100%)",
              borderRadius: 3,
              overflow: "hidden",
              cursor: "pointer",
              ...
              "&:hover": {
                ...
                background: "linear-gradient(145deg, hsl(var(--card-dark)) 0%, hsla(var(--card-gradient-end), 0.15) 100%)",
              },
            }}
